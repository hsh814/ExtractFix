...
@.str = private unnamed_addr constant [32 x i8] c"Normal string allocation error\0A\00", align 1
@.str.1 = private unnamed_addr constant [31 x i8] c"Large string allocation error\0A\00", align 1

; Function Attrs: noinline nounwind uwtable
define i8* @getNormalStr() #0 !dbg !14 {
  %1 = call noalias i8* @malloc(i64 20) #6, !dbg !17
...
; <label>:3:                                      ; preds = %0
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str, i32 0, i32 0)), !dbg !24
...
define i8* @getLongStr() #0 !dbg !31 {
  %1 = call noalias i8* @malloc(i64 4294967294) #6, !dbg !32
...
; <label>:3:                                      ; preds = %0
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i32 0, i32 0)), !dbg !38
